...
export default function Projects() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Landscape Projects &amp; Case Studies in Kenya | Botanique Designers</title>
        <meta name="description" content="Selected landscape projects and case studies by Botanique Designers across Kenya — residential gardens, estate and institutional grounds, coastal and ecological planting." />
      ...
      <section className="max-w-6xl mx-auto px-6 pt-12">
        <div className="text-center mb-8">
          <p className="text-botanique-green text-sm font-semibold uppercase tracking-widest mb-2">
            Featured Case Studies
          </p>
          <h2 className="text-2xl md:text-3xl font-bold text-botanique-charcoal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {caseStudies.map((cs) => (
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden bg-botanique-beige">
                <img
                  src={cs.heroImage}
                  alt={cs.title}
                  loading="lazy"
                ...
                />
                <span className="absolute top-3 left-3 px-2.5 py-1 rounded-full text-xs font-semibold bg-white/90 text-botanique-green">
                  {cs.status}
                </span>
              </div>
              <div className="p-5">
                ...
                <p className="text-sm text-gray-500 mt-1">{cs.location}</p>
                <p className="text-xs text-gray-400 mt-2 line-clamp-2 leading-relaxed">
                  {cs.summary}
                </p>
                <span className="inline-block mt-3 text-sm font-medium text-botanique-green group-hover:underline">
                  View case study →
                </span>
              </div>
            </Link>
      ...
      {/* Gallery heading */}
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-2 text-center">
        <p className="text-botanique-green text-sm font-semibold uppercase tracking-widest mb-2">
          Selected Works
        </p>
        <h2 className="text-2xl md:text-3xl font-bold text-botanique-charcoal">
