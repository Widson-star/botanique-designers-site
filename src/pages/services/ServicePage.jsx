...
export default function ServicePage() {
  ...
  const relatedCaseStudies = caseStudies.filter((cs) =>
    (cs.relatedServices || []).includes(slug)
  );
  ...
  return (
    <div className="pt-20">
      <Helmet>
        <title>{`${svc.title} in Kenya | Botanique Designers`}</title>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: `https://www.botaniquedesigners.com/services/${svc.slug}`,
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Services", item: "https://www.botaniquedesigners.com/services" },
              { "@type": "ListItem", position: 3, name: svc.title, item: `https://www.botaniquedesigners.com/services/${svc.slug}` },
            ],
          })}
        </script>
      </Helmet>
      ...
      {/* Selected Projects (case studies linked to this service) */}
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {relatedCaseStudies.map((cs) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <span className="text-xs text-botanique-green/70 font-medium">{cs.status}</span>
                      <h3 className="font-bold text-botanique-charcoal mt-1 group-hover:text-botanique-green transition-colors">
                        {cs.title}
                      </h3>
