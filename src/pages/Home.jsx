      ...
      >
        ...
        <div className="relative z-10 max-w-3xl px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={() => openQuoteWizard("", { source: "Homepage hero" })}
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <FadeIn delay={200}>
            <div className="mt-12 flex flex-col items-center gap-3">
              <button
                onClick={() => openQuoteWizard("", { source: "Homepage — how we work" })}
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <FadeIn delay={150}>
            <div className="bg-white rounded-2xl shadow-md p-10">
              <button
                onClick={() => openQuoteWizard("", { source: "Homepage project enquiry" })}
            ...
            {filtered.slice(0, 6).map((project, index) => (
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() => openQuoteWizard("", { source: `Homepage projects — ${project.title}` })}
                  ...
                  <div className="space-y-6 text-white/80 text-sm">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href={`tel:${CONTACT.phoneTel}`} className="hover:text-botanique-green transition">
