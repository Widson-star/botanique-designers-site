      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            ...(post.image
              ? { image: `https://www.botaniquedesigners.com${post.image}` }
              : {}),
            author: {
              "@type": "Person",
              name: "Widson Ambaisi",
            ...
            mainEntityOfPage: `https://www.botaniquedesigners.com/blog/${post.slug}`,
          })}
        </script>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Blog", item: "https://www.botaniquedesigners.com/blog" },
              { "@type": "ListItem", position: 3, name: post.title, item: `https://www.botaniquedesigners.com/blog/${post.slug}` },
            ],
          })}
        </script>
      </Helmet>
