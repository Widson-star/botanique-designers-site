  ...
  return <section className="space-y-4">
    ...
    <div className="grid gap-4 lg:grid-cols-[minmax(0,1.45fr)_minmax(300px,.75fr)] lg:items-start">
      <div className="space-y-4">
        ...
        <Panel title="Field execution · Daily Site Record" action={relationship.status === "active" && canManageMaintenance(role) && <Link to={`/admin/daily-site-operations/new?project=${relationship.projectId}`} className="min-h-9 py-2 text-[12px] font-semibold text-botanique-green">Record field work</Link>}>
          <p className="mb-3 text-[11.5px] leading-relaxed text-gray-500">This is the actual day-of-work record: what was done, casual/site crew, evidence state and review state. Named Botanique staff remain separate under the Maintenance team and Staff Pay.</p>
