...
// customer — showing "payment sent" would be misleading. Until production Daraja
// credentials are confirmed and VITE_MPESA_STK_ENABLED is set to "true", we show
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl">
        ...
        {/* Payment section */}
        {!MPESA_STK_ENABLED ? (
          /* Not live: honest manual payment instructions only (no fake STK prompt) */
          <div className="text-sm">
            <p className="text-gray-600 mb-4">
              To confirm your site visit, pay the fee using the details below and
              send us your M-Pesa or bank confirmation on WhatsApp. We'll lock in
              your visit as soon as payment is received.
            </p>
            <div className="bg-gray-50 rounded-xl px-4 py-3 text-gray-700 space-y-1">
            ...
            <button onClick={handleClose} className="mt-3 w-full text-sm text-gray-500 hover:underline">
              Close
            </button>
          </div>
        ) : status === "sent" ? (
