...
const serviceCategories = [
  {
    ...
    items: [
      ...
      { label: "Ecological & Native Planting Design", path: "/services/ecological-planting-design" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { label: "Commercial, Institutional & Hospitality", path: "/services/commercial-landscaping" },
    ],
  },
];
