      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><Link to="/services/ecological-planting-design" className="hover:text-white transition">Ecological & Native Planting</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300 mb-6">
            ...
            <li>
              <a href="mailto:widson@botaniquedesigners.com" className="hover:text-white transition flex items-center gap-2">
