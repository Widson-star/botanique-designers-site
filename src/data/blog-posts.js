...
This is where landscape design diverges sharply from general gardening advice. At Botanique, we work with a growing plant reference built specifically for East African conditions — cross-referenced against rainfall, soil type, sunlight exposure, and maintenance requirements.
...
If you're unsure which direction suits your property, [contact us](/#contact) and we'll walk through it with you.`,
  },
  {
    ...
    title: "Meet Ask Botanique: The Assistant on Our Website",
    date: "2024-11-15",
    category: "Plant Science",
    excerpt:
      "Ask Botanique is the friendly assistant on the Botanique Designers website — here to help you with services, site visits, plant questions, and consultation options.",
    content: `When clients reach out to us, the same questions come up again and again: what do you charge for a site visit, do you work in my area, what will survive in my garden, how do I get started? Ask Botanique, the assistant on our website, exists to answer those questions quickly — any time of day.

Ask Botanique is simply our website assistant. It's not a separate product or company; it's the chat bubble in the corner of botaniquedesigners.com, set up to help visitors get oriented before they speak to us directly.
...
**Quick plant and garden questions.** When you ask "what grows well in Karen?" or "which grass suits a shaded Nairobi lawn?", the answers draw on our team's field experience designing and planting gardens across Kenya — altitude, rainfall, soil, and how you actually use the space all matter.

Ask Botanique is there to make getting in touch easier — not to replace a real conversation. For anything specific to your property, it will always nudge you toward a proper site visit, because that's where good landscape design actually starts.`,
  },
  {
