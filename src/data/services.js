const services = {
  categories: [
    {
      ...
      services: ["landscape-design", "landscape-architecture", "ecological-planting-design"],
    },
    {
      id: "plant-science",
      title: "Plant Science & Advisory",
      description: "The horticultural depth behind every planting decision.",
    ...
    {
      id: "commercial",
      title: "Commercial, Institutional & Hospitality",
      description: "Larger landscapes for offices, hotels, schools, estates, and public spaces.",
  ...
  items: {
    ...
    "plant-taxonomy": {
      ...
      included: [
        ...
        },
        {
          ...
          desc: "Optional QR codes linking to species information for each labelled plant.",
        },
      ],
      process: [
        {
        ...
        },
        {
          ...
          desc: "Confirm identifications using herbarium references and standard botanical keys.",
        },
        {
    ...
    "ecological-planting-design": {
      ...
      description:
        "Ecological planting design starts from the site, not a catalogue. We select native and well-adapted species that suit your local rainfall, soil, altitude, and light — so the planting establishes faster, needs less water, and supports pollinators and local biodiversity. It's a practical approach for water-wise gardens, slopes and erosion-sensitive ground, and clients who want a landscape that works with its environment rather than against it.",
      included: [
        {
          title: "Site & Climate Reading",
          desc: "Assessment of rainfall zone, soil, altitude, slope, and sun/shade before any species are chosen.",
        },
        {
          title: "Native & Adapted Species",
          desc: "Planting palettes built around indigenous and well-adapted species suited to the site.",
        },
        {
          title: "Water-Wise Planting",
          desc: "Drought-tolerant groundcovers, grasses, and shrubs that reduce irrigation demand.",
        },
        {
          title: "Pollinator-Friendly Layers",
          desc: "Flowering and habitat planting that supports bees, butterflies, and birds.",
        },
        {
          title: "Erosion-Sensitive Design",
          desc: "Stabilising planting for slopes, banks, and exposed ground.",
        },
        {
          title: "Establishment Guidance",
          desc: "Mulching, soil preparation, and aftercare so the planting establishes well.",
        },
      ],
      process: [
        {
          step: "Site Assessment",
          desc: "We read the site's soil, water, altitude, and existing vegetation.",
        },
        {
          step: "Planting Strategy",
          desc: "We propose a native/adapted palette and planting structure for your conditions.",
        },
        {
          step: "Planting Plan",
          desc: "Detailed species schedule with quantities, spacing, and layout.",
        },
        {
          step: "Establishment Support",
          desc: "Guidance or implementation to get the planting through its first seasons.",
        },
      ],
    },
    "commercial-landscaping": {
      slug: "commercial-landscaping",
      title: "Commercial, Institutional & Hospitality Landscaping",
      category: "commercial",
      lead: "Botanique Designers — Design & Build Team",
      heroImage: "/projects/ksms-1.jpg",
      shortDescription:
        "Landscape design and implementation for offices, hotels, schools, hospitals, estates, and public spaces.",
      description:
        "Larger sites bring different demands — higher footfall, longer sightlines, irrigation across wide areas, and planting that has to look good with practical maintenance. We design and deliver landscapes for offices, hotels and resorts, schools and institutions, hospitals, estates, and public spaces, coordinating planting, irrigation, hardscape, and ongoing maintenance under one team. Projects can run from concept and planting design through to full implementation and a maintenance programme.",
      included: [
        {
          title: "Master Planning",
          desc: "Site-wide layout integrating buildings, circulation, parking, and landscape.",
        },
        {
          title: "Commercial Planting Design",
          desc: "Durable, high-impact, lower-maintenance planting suited to public and high-traffic areas.",
        },
        {
          title: "Irrigation at Scale",
          desc: "Zoned irrigation planning for larger grounds and varied planting needs.",
        },
        {
          title: "Hardscape Coordination",
          desc: "Paths, paving, walls, and outdoor structures coordinated with the planting.",
        },
        {
          title: "Phased Implementation",
          desc: "Delivery planned around your operations and construction programme.",
        },
        {
      ...
      process: [
        {
          step: "Brief & Site Visit",
          desc: "We assess the site, your operational needs, and the standard you need to maintain.",
        },
        {
          step: "Concept & Master Plan",
          desc: "We develop a landscape master plan with planting direction and budget guidance.",
        },
        {
          step: "Implementation",
          desc: "We deliver the works — planting, irrigation, and hardscape coordination — in planned phases.",
        },
        {
